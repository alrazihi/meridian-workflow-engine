...
import com.meridian.infrastructure.web.filter.WebhookAuthenticationFilter;
...
@Import({SecurityConfig.class, MethodSecurityConfig.class, WebhookAuthenticationFilter.class})
